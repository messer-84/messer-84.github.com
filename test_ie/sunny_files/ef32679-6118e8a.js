...
!function (t) {
  if ("function" == typeof define && define.amd && define("uikit", function () {
        ...
        return n.load = function (t, e, o, i) {
          var r, a = t.split(","), s = [], u = (i.config && i.config.uikit && i.config.uikit.base ? i.config.uikit.base : "").replace(/\/+$/g, "");
          if (!u)throw new Error("Please define base path to UIkit in the requirejs config.");
          for (r = 0; r < a.length; r += 1) {
            var c = a[r].replace(/\./g, "/");
            s.push(u + "/components/" + c)
          }
          e(s, function () {
            o(n)
          })
  ...
  if (o.version = "2.27.1", o.noConflict = function () {
        ...
        t && setTimeout(function () {
          try {
            for (d = document.styleSheets, i = 0, s = d.length; s > i; i++) {
              ...
              for (a = 0, c = e.length; c > a; a++)o.deleteRule(e[a])
            }
          } catch (l) {
          }
        }, 0)
        ...
        var r = o.$win.scrollLeft(), a = o.$win.scrollTop(), s = i.offset(), u = s.left, c = s.top;
        return e = n.extend({
          topoffset: 0,
          leftoffset: 0
        }, e), c + i.height() >= a && c - e.topoffset <= a + o.$win.height() && u + i.width() >= r && u - e.leftoffset <= r + o.$win.width() ? !0 : !1
        ...
        t = n(t);
        var o, i = t.find("[autofocus]:first");
        return i.length ? i.focus() : (i = t.find(":input" + (e && "," + e || "")).first(), i.length ? i.focus() : (t.attr("tabindex") || (o = 1e3, t.attr("tabindex", o)), t[0].focus(), o && t.attr("tabindex", ""), t))
      }, o.Utils.events = {}, o.Utils.events.click = o.support.touch ? "tap" : "click", t.UIkit = o, o.fn = function (t, e) {
        var i = arguments, r = t.match(/^([a-z\-]+)(?:\.([a-z]+))?/i), a = r[1], s = r[2];
        return o[a] ? this.each(function () {
              var t = n(this), r = t.data(a);
        ...
        var t = function () {
          o.$body = o.$("body"), o.trigger("beforeready.uk.dom"), o.component.bootComponents();
          var t = requestAnimationFrame(function () {
            var n = {dir: {x: 0, y: 0}, x: window.pageXOffset, y: window.pageYOffset}, e = function () {
              var i = window.pageXOffset, r = window.pageYOffset;
              (n.x != i || n.y != r) && (n.dir.x = i != n.x ? i > n.x ? 1 : -1 : 0, n.dir.y = r != n.y ? r > n.y ? 1 : -1 : 0, n.x = i, n.y = r, o.$doc.trigger("scrolling.uk.document", [{
                dir: {
                  x: n.dir.x,
                  y: n.dir.y
                }, x: i, y: r
          ...
          if (o.trigger("domready.uk.dom"), o.support.touch && navigator.userAgent.match(/(iPad|iPhone|iPod)/g) && o.$win.on("load orientationchange resize", o.Utils.debounce(function () {
            ...
            new o.support.mutationobserver(function (t) {
              var n = !1;
              t.every(function (t) {
                if ("childList" != t.type)return !0;
                for (var e, o = 0; o < t.addedNodes.length; ++o)if (e = t.addedNodes[o], e.outerHTML && -1 !== e.outerHTML.indexOf("data-uk-"))return (n = !0) && !1;
                return !0
              }), n && e()
    ...
    var r, a = !1, s = "uk-hover", u = ".uk-overlay, .uk-overlay-hover, .uk-overlay-toggle, .uk-animation-hover, .uk-has-hover";
...
!function (t) {
  ...
  t.component("stackMargin", {
    ...
    var i = [], e = function (t) {
      if (t.is(":visible")) {
        var i = t.parent().width(), e = t.data("width"), n = i / e, s = Math.floor(n * t.data("height"));
        t.css({height: e > i ? s : t.data("height")})
      }
    };
    ...
    var n = !1;
    i.each(function (i, e, s, a) {
      a = t.$(this), "none" != a.css("display") && (i = a.offset(), e = a.outerHeight(), s = i.top + e, a.data({
        ukMarginPos: s,
        ukMarginTop: i.top
      }), (n === !1 || i.top < n.top) && (n = {top: i.top, left: i.left, pos: s}))
    }).each(function (i) {
    ...
    e.row ? (i.first().width(), setTimeout(function () {
          ...
          i.each(function () {
            ...
            a != e && s.length && (n(t.$(s)), s = [], a = i.offset().top), s.push(i), e = a
          }), s.length && n(t.$(s))
        }, 0)) : n(i)
  }, function (i) {
...
!function (t) {
  ...
  function i(i) {
    var s = t.$(i), e = "auto";
    if (s.is(":visible")) e = s.outerHeight(); else {
      var a = {position: s.css("position"), visibility: s.css("visibility"), display: s.css("display")};
      e = s.css({position: "absolute", visibility: "hidden", display: "block"}).outerHeight(), s.css(a)
    }
    return e
  }
  ...
  t.component("nav", {
    ...
    init: function () {
      ...
      this.on("click.uk.nav", this.options.toggle, function (s) {
        ...
        i.element.find(this.options.lists).not("[role]").length && i.update()
      })
    },
    update: function () {
      var i = this;
      this.find(this.options.lists).each(function () {
        var s = t.$(this).attr("role", "menu"), e = s.closest("li"), a = e.hasClass("uk-active");
        e.data("list-container") || (s.wrap('<div style="overflow:hidden;height:0;position:relative;"></div>'), e.data("list-container", s.parent()[a ? "removeClass" : "addClass"]("uk-hidden"))), e.attr("aria-expanded", e.hasClass("uk-open")), a && i.open(e, !0)
      })
    },
    open: function (s, e) {
      var a = this, n = this.element, o = t.$(s), l = o.data("list-container");
...
!function (t) {
  ...
  t.component("dropdown", {
    defaults: {
      ...
      t.$html.on(o + ".dropdown.uikit focus", "[data-uk-dropdown]", function (e) {
        var i = t.$(this);
        if (!i.data("dropdown")) {
      ...
      if (this.dropdown.length) {
        ...
        var e, i = t.$.extend({}, this.offsetParent.offset(), {
          width: this.offsetParent[0].offsetWidth,
          height: this.offsetParent[0].offsetHeight
        }), r = this.options.offset, s = this.dropdown, d = (s.show().offset() || {
          left: 0,
          top: 0
        }, s.outerWidth()), h = s.outerHeight(), l = this.boundary.width(), p = (this.boundary[0] !== window && this.boundary.offset() ? this.boundary.offset() : {
              top: 0,
              left: 0
            }, this.options.pos), a = {
          "bottom-left": {top: 0 + i.height + r, left: 0},
          "bottom-right": {top: 0 + i.height + r, left: 0 + i.width - d},
          "bottom-center": {top: 0 + i.height + r, left: 0 + i.width / 2 - d / 2},
          "top-left": {top: 0 - h - r, left: 0},
          "top-right": {top: 0 - h - r, left: 0 + i.width - d},
          "top-center": {top: 0 - h - r, left: 0 + i.width / 2 - d / 2},
          "left-top": {top: 0, left: 0 - d - r},
          "left-bottom": {top: 0 + i.height - h, left: 0 - d - r},
          "left-center": {top: 0 + i.height / 2 - h / 2, left: 0 - d - r},
          "right-top": {top: 0, left: 0 + i.width + r},
          "right-bottom": {top: 0 + i.height - h, left: 0 + i.width + r},
          "right-center": {top: 0 + i.height / 2 - h / 2, left: 0 + i.width + r}
        }, f = {};
    ...
    defaults: {justify: !1, cls: "", duration: 200}, boot: function () {
      ...
      this.justified = this.options.justify ? t.$(this.options.justify) : !1, this.overlay = this.element.find("uk-dropdown-overlay"), this.overlay.length || (this.overlay = t.$('<div class="uk-dropdown-overlay"></div>').appendTo(this.element)), this.overlay.addClass(this.options.cls), this.on({
        "beforeshow.uk.dropdown": function (t, i) {
          e.dropdown = i, e.justified && e.justified.length && o(e.overlay.css({
            display: "block",
            "margin-left": "",
            "margin-right": ""
...
!function (a) {
  "use strict";
  var t = {x: window.scrollX, y: window.scrollY}, n = (a.$win, a.$doc, a.$html), i = {
    show: function (i, o) {
      if (i = a.$(i), i.length) {
        o = a.$.extend({mode: "push"}, o);
        var e = a.$("body"), s = i.find(".uk-offcanvas-bar:first"), r = "right" == a.langdirection, f = s.hasClass("uk-offcanvas-bar-flip") ? -1 : 1, c = f * (r ? -1 : 1), h = window.innerWidth - e.width();
        t = {
          x: window.pageXOffset,
          y: window.pageYOffset
        }, s.attr("mode", o.mode), i.addClass("uk-active"), e.css({
          width: window.innerWidth - h,
          height: window.innerHeight
        }).addClass("uk-offcanvas-page"), ("push" == o.mode || "reveal" == o.mode) && e.css(r ? "margin-right" : "margin-left", (r ? -1 : 1) * s.outerWidth() * c), "reveal" == o.mode && s.css("clip", "rect(0, " + s.outerWidth() + "px, 100vh, 0)"), n.css("margin-top", -1 * t.y).width(), s.addClass("uk-offcanvas-bar-show"), this._initElement(i), s.trigger("show.uk.offcanvas", [i, s]), i.attr("aria-hidden", "false")
      }
    }, hide: function (i) {
      var o = a.$("body"), e = a.$(".uk-offcanvas.uk-active"), s = "right" == a.langdirection, r = e.find(".uk-offcanvas-bar:first"), f = function () {
        o.removeClass("uk-offcanvas-page").css({
          width: "",
          height: "",
          "margin-left": "",
          "margin-right": ""
        }), e.removeClass("uk-active"), r.removeClass("uk-offcanvas-bar-show"), n.css("margin-top", ""), window.scrollTo(t.x, t.y), r.trigger("hide.uk.offcanvas", [e, r]), e.attr("aria-hidden", "true")
      };
  ...
  a.component("offcanvasTrigger", {
    boot: function () {
      ...
      this.options = a.$.extend({
        target: t.element.is("a") ? t.element.attr("href") : !1,
        mode: "push"
    ...
    resize: function (t) {
      if (this.isActive() || t) {
        ...
        if (this.scrollbarwidth = window.innerWidth - i, e.css(this.paddingdir, this.scrollbarwidth), this.element.css("overflow-y", this.scrollbarwidth ? "scroll" : "auto"), !this.updateScrollable() && this.options.center) {
          var o = this.dialog.outerHeight(), n = parseInt(this.dialog.css("margin-top"), 10) + parseInt(this.dialog.css("margin-bottom"), 10);
          o + n < window.innerHeight ? this.dialog.css({top: window.innerHeight / 2 - o / 2 - n}) : this.dialog.css({top: ""})
        }
      }
    },
...
!function (t) {
    ...
    function o(t) {
      if (r(), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
        ...
        for (var h = o.isBorderBox = !(!a || !e[a] || "border-box" !== e[a]), u = 0, l = c.length; l > u; u++) {
          var f = c[u], p = e[f], g = parseFloat(p);
          o[f] = isNaN(g) ? 0 : g
        }
  ...
  t.component("grid", {
    defaults: {
      ...
      this.gutterv = parseInt(e[0], 10), this.gutterh = parseInt(e[1] || e[0], 10), this.element.css({position: "relative"}), this.controls = null, this.origin = this.options.origin, this.options.controls && (this.controls = t.$(this.options.controls), this.controls.on("click", "[data-uk-filter]", function (e) {
      ...
      k -= this.gutterv, this.options.animation ? (this.element.stop().animate({height: k}, 100), v.forEach(function (t) {
...
if (!YT.loading) {
  ...
  (function () {
    ...
    a.src = 'http://s.ytimg.com/yts/jsbin/www-widgetapi-vflyiGtkL/www-widgetapi.js';
    a.async = true;
...
!function (t, e, i) {
  !function () {
    var s, a, n, h = "2.2.3", o = "datepicker", r = ".datepicker-here", c = !1, d = '<div class="datepicker"><i class="datepicker--pointer"></i><nav class="datepicker--nav"></nav><div class="datepicker--content"></div></div>', l = {
      classes: "",
      inline: !1,
      language: "ru",
      startDate: new Date,
    ...
    n = m, n.prototype = {
      VERSION: h, viewIndexes: ["days", "months", "years"], init: function () {
        ...
        e = e || this.date;
        var i, s = t, a = this._getWordBoundaryRegExp, h = this.loc, o = n.getLeadingZeroNum, r = n.getDecade(e), c = n.getParsedDate(e), d = c.fullHours, l = c.hours, u = t.match(a("aa")) || t.match(a("AA")), m = "am", p = this._replacer;
        ...
        var i = t.getTime(), s = n.getParsedDate(t), a = n.getParsedDate(this.minDate), h = n.getParsedDate(this.maxDate), o = new Date(s.year, s.month, a.date).getTime(), r = new Date(s.year, s.month, h.date).getTime(), c = {
        ...
        var e, i, s = this._getDimensions(this.$el), a = this._getDimensions(this.$datepicker), n = t.split(" "), h = this.opts.offset, o = n[0], r = n[1];
        switch (o) {
          case"top":
            e = s.top - a.height - h;
            break;
        ...
        var e, i, s, a = n.getParsedDate(this._getFocusedDate()), h = this.opts, o = !1, r = !1, c = !1, d = a.year, l = a.month, u = a.date;
        switch (t) {
          case"ctrlRight":
          case"ctrlUp":
            l += 1, o = !0;
    ...
    s.Body = function (t, i, s) {
      ...
      init: function () {
        ...
        var i = "datepicker--cell datepicker--cell-" + e, s = new Date, n = this.d, h = a.resetTime(n.minRange), o = a.resetTime(n.maxRange), r = n.opts, c = a.getParsedDate(t), d = {}, l = c.date;
        switch (e) {
          case"day":
...
$(document).ready(function () {
  ...
  initMenuOverlay();
  initHeader();
  initRecirculationSlider();
  initSearchOverlay();
  initContactOverlay();
  initSliderQuotes();
  initDocuments();
  initHeroSlider();
  protectedPageFunctions();
  initAllPhotoVideoCarousel();
  initCategoriesList();
  initCalendar();
  initEventsPages();
  initDirectionsMap();
...
$window.on('resize', $.throttle(250, resizeGl));

$(window).on('orientationchange', $.throttle(250, resizeGl));
...
$(window).on('scroll', scroll_global);

function scroll_global() {
...
$(document).ready(function () {
  ...
  $easeInOut_4 = Power4.easeInOut;
  $easeOut_4 = Power4.easeOut;
  $easeIn_4 = Power4.easeIn;
...
function initHeroAnim() {
  var $m__hero_overlay = $('.m__hero_overlay');
  var $position_shift = 140;

  if (!$m__hero_overlay.length) {
    return;
  }
  ...
  var past_$scrollTopGl = $scrollTopGl;

  function anim_f() {
    if (past_$scrollTopGl !== $scrollTopGl) {
      if (window_w < 1440) {
        $position_shift = 90;
      } else {
        $position_shift = 140;
      ...
      $.each(m__hero_array, function (key, value) {
        var $progress = 0;
        var $position = value.position - $position_shift;

        if ($scrollTopGl > $position) {
          $progress = ($scrollTopGl - $position) / value.height;
        }
...
// guys it cause recalculation on whole dom every time you launch these functions
...
/**
 * Returns true if we are below Landscape Tablet breakpoint
 * @returns {boolean}
 */
function isBelowTablet() {
  return window_w <= 768;
}
...
/**
 * Read more in the search result page. It has to account for different
 * CPTs and different pages at the same time.
 */
function initSearchReadMore() {
  var $button = $('.search_read_more');

  if (!$button.length) {
    return;
  }
  var ENDPOINT = '//' + window.location.host + '/wp-json/wp/v2/';
  var query = $('.t__search_page').attr('data-query');
  var eventsPage = 2;
  // Articles and posts pre-load 6, and we want to render only the next 3, so we skip pages 1 and 2 in that case.
  var articlesNewsPage = 3;
  var postsPage = 3;

  $button.on('click', function () {
    var $el = $(this);
    fetchData($el.attr('data-cpt'), $el);
  });

  function fetchData(cpt, $button) {
    var url = ENDPOINT + cpt;
    url += '?search=' + query;
    var page = 1;
    switch (cpt) {
      case 'sun_article':
        page = articlesNewsPage;
        articlesNewsPage++;
        break;
      case 'sun_event':
        page = eventsPage;
    ...
    $.ajax({
      ...
      if ('sun_event' === cpt) {
        for (var i = 0; i < data.length; i++) {
          $button.before(renderSingleEvent(data[i]));
        }
      } else {
        $button.before(renderNewsRow(data));
      }
    });
  }

  function renderNewsRow(data) {
    var html = (
        '<div class="o__news_page o_content_thumbnails"><div class="blocks_wrap">'
    );

    for (var i = 0; i < data.length; i++) {
      html += renderUniquePost(data[i]);
    }
  ...
  function renderUniquePost(info) {
    return (
        ...
        '<img src="' + info.acf.thumbnail_list_image + '" alt="thumbnail" class="content_t_img">' +
        '</div>' +
        ...
        info.date +
        '</div>' +
        '<div class="content_t_text">' +
        info.article_excerpt +
        '</div>' +
        'Read More' +
        '</div>' +
        '</div>' +
  ...
  function renderSingleEvent(info) {
    return (
        '<div class="m__search_event">' +
        '<img class="thumbnail" src="' + info.acf.featured_image + '">' +
        '<div class="info">' +
        '<a href="' + info.link + '"><div class="title">' + info.title.rendered + '</div></a>' +
        '<div class="location">' + info.locations + '</div>' +
        '<div class="copy">' + info.event_excerpt + '</div>' +
        '<div class="event_date_info">' +
        '<div class="event_day info_outer">' + info.acf.recurrency + '</div>' +
        '<div class="event_day info_inner"> ' + info.acf.additional_info + '</div>' +
        '</div>' +
        '</div>' +
        '</div>'
    );
...
function initHeader() {
  var $header = $('.o__header');
  var $header_sub = $('.o__header_sub');
  var $wrapper = $('.tm-site');
  var $progress = $('.navbar_progress');
  ...
  var progress_tl = TweenMax.to($progress, 1, {
    xPercent: 100,
  ...
  var sidbar_menu_tl = new TimelineMax({paused: true});
  sidbar_menu_tl
      .to('.m__sidebar', 1, {
        y: -40,
        ease: Power0.easeNone
  ...
  function load() {
    resize();
    change();
    TweenLite.ticker.addEventListener("tick", change);
  }
  ...
  function change() {
    var header_pos = $scrollTopGl <= 45 ? $scrollTopGl / 45 : 1;
    if (header_pos <= 1 && window_w > 768) {
      header_tl.progress(header_pos);

      if (window_w < 1440 && window_w > 768) {
        sidbar_menu_tl.progress(header_pos);
      }
    }

    var pctScrolled = Math.floor(($scrollTopGl / (d_height - window_h)) * 100);
    if (pctScrolled <= 100) {
      progress_tl.progress(pctScrolled / 100);
    }
  }


  $window.scroll(function () {
    $header.toggleClass('collapsed', $scrollTopGl >= collapseHeight);
    $wrapper.toggleClass('collapsed', $scrollTopGl >= collapseHeight);
  });
}

/**
 * Universal - Photo & Video Carousel Module
 */

function initAllPhotoVideoCarousel() {
  $('.carousel_module_list').each(
      function () {
        var thatElem = $(this);
        photoVideoCarousel(thatElem);
      }
  );
}

function photoVideoCarousel(carouselItem) {
  var prefix;
  var carousel;
  var slide_num;
  var slide_all;
  ...
  function initCarouselModule() {
    ...
    var carouselDescArray = [];
    var carouselTitleArray = [];
    var carouselLinkArray = [];
    carousel = carouselItem;
    var carouselModule = carousel.parent('.o__carousel_module');

    slide_num = $('.slide_num', carouselModule);
    slide_all = $('.slide_all', carouselModule);
    ...
    // create Array elements-text and hide all them
    $(".carousel_module_item", carousel).each(function () {
      var $this = $(this);
      var imgEl = $(".carousel_img_hold", $this);
      var descEl = $(".carousel_d_desc", $this);
      var titleEl = $(".carousel_d_title", $this);
      var linkEl = $(".carousel_read_more", $this);

      carouselImagesArray.push(imgEl);
      carouselDescArray.push(descEl);
      carouselTitleArray.push(titleEl);
      carouselLinkArray.push(linkEl);

      hideAllNonActiveElem(descEl);
      hideAllNonActiveElem(titleEl);
      hideAllNonActiveElem(linkEl);


    });


    //show first element-text and show progress bar
    carousel.on('init', function (event, slick) {
      carouselLen = carousel.find('.carousel_module_item').length;
      var item = carousel.find('.carousel_module_item');
      indexCurrent = carousel.find('.slick-slide.slick-current').index();

      prevSlide = item.eq(carouselLen - 1);
      nextSlide = item.eq(indexCurrent + 1);
      prevSlide.addClass('PREVSLIDE');
      nextSlide.addClass('NEXTSLIDE');

      addClassVideoIframe();
      emulationSlickArrows();
      setStartPosition(carouselLinkArray[0]);
      initCarouselAnimationItem(carouselDescArray[0]);
      initCarouselAnimationItem(carouselTitleArray[0]);
      initCarouselAnimationItem(carouselLinkArray[0]);

      getCountSlides(slick.$slides, slide_all);
      getCurrentSlide(slick, slide_num);
    ...
    // there is animations with text and img

    carousel.on('beforeChange', function (event, slick, currentSlide, nextSlide) {


      TweenMax.set(carouselLinkArray[nextSlide], {xPercent: 100, opacity: 1, scale: 1});

      getCurrentSlide(slick, slide_num);
      childrenClass = carouselImagesArray[currentSlide].children().attr('class');


      if (childrenClass == 'iframeVideo' || childrenClass == 'html5Video') {
        superIndex = currentSlide;
      }
      else {
        superIndex = false
      }

      if ($('.slick_arrow_fake.next').hasClass('active')) {
        direction = 'right'
      }
      if ($('.slick_arrow_fake.prev').hasClass('active')) {
        direction = 'left'
      }
      ...
      if (direction === 'right') {
        ...
        moveSlideToRight(carouselTitleArray, nextSlide, currentSlide);
        ...
        moveSlideToLeft(carouselTitleArray, nextSlide, currentSlide);
      }

    });

    carousel.on('afterChange', function (event, slick, currentSlide) {
      $('video', carousel).attr('controls', 'controls');

      if (childrenClass == 'iframeVideo') {
        var elem = carouselImagesArray[superIndex].children();
        var pathElem = elem.attr('src');

        elem.attr('src', pathElem);
        superIndex = false;
      }

      if (childrenClass == 'html5Video') {

        carouselImagesArray[superIndex].children().get(0).pause();
        superIndex = false;
      }
  ...
  function toggleClassArrowFake(elem) {
    var that = $(elem);
    $('.slick_arrow_fake').removeClass('active');
    if (!that.hasClass('active')) {
      that.addClass('active');
    }
  }

  function emulationSlickArrows() {
    var item = carousel.find('.carousel_module_item');
    carouselLen = carousel.find('.carousel_module_item').length;
    indexLast = carouselLen - 1;
    var itemLast = item.eq(indexLast);
    var itemZero = item.eq(0);

    $('.slick_arrow_fake.next', carousel.parent('.o__carousel_module')).on('click', function () {
      toggleClassArrowFake(this);
      carousel.slick("slickNext");
      indexCurrent = carousel.find('.slick-slide.slick-current').index();


      if (indexCurrent == indexLast) {
        prevSlide = item.eq(indexCurrent - 1);
        nextSlide = itemZero;
      }
      ...
      setClassSlides(prevSlide, nextSlide);
      direction = 'right';

    });
    $('.slick_arrow_fake.prev', carousel.parent('.o__carousel_module')).on('click', function () {
      toggleClassArrowFake(this);
  ...
  function setClassSlides(prev, next) {
    var prevCl = 'PREVSLIDE', nextCl = 'NEXTSLIDE';
    carousel.find('.' + prevCl).removeClass(prevCl);
    carousel.find('.' + nextCl).removeClass(nextCl);
    prev.addClass(prevCl);
    next.addClass(nextCl);
  }

  function initCarouselAnimationItem(elem) {
    TweenMax.to(elem, 1, {yPercent: 0, opacity: 1});
  }

  function hideAllNonActiveElem(array) {
    TweenMax.set(array, {yPercent: 2, opacity: 0});
  }
  ...
  function getCurrentSlide(slick, elem) {
    var numCurrentSlide = slick.currentSlide;
    prefix = slick.currentSlide < 10 ? '0' : '';

    elem.text(prefix + (numCurrentSlide + 1));
  }

  function getCountSlides(slickSlides, elem) {
    prefix = slickSlides.length < 10 ? '0' : '';

    elem.text(prefix + slickSlides.length);

  }
}

//todo js fix
function addClassVideoIframe() {
  $('iframe').each(function () {
    var that = $(this);
    var path = that.attr('src');
    if (typeof path !== 'undefined' && path.length > 0) {
      if (path.indexOf('youtu.be') != -1) {
        changeUrlYoutube(path, that);
      }
    }
    else {
      return;
    ...
    if (path.indexOf('youtube') != -1 || path.indexOf('youtu.be') != -1 || path.indexOf('vimeo') != -1) {
      that.addClass('iframeVideo');
    }
  });

}

//  video with short url doesn't show. it's fix;
function changeUrlYoutube(path, that) {
  var $ytshorturl = 'youtu.be/';
  var $ytlongurl = 'www.youtube.com/embed/';

  path = path.replace($ytshorturl, $ytlongurl);
  that.attr('src', path);
}
...
/**
 * White overlay for contact form.
 */
...
function initContactOverlay() {
  ...
  var $fieldFocus = $('.ginput_container').children();
  if (!$contact.length) {
    return;
  }
...
function checkNotEmpty() {
  ...
  function notEmpty(objElem) {
    if ($(objElem).val() !== '') {
      $(objElem).closest('li').find('.gfield_label').addClass('not_empty');
    }
  }
 ...
 * ID.
 *
 * This JS will trigger the overlay and make the ajax request to fill the information according
...
function initDocuments() {
  var $documents = $('.o__documents');

  if (!$documents.length) {
    return
  }
  var $slider = $documents.find('.documents-slider');
  var options = {
    dots: true,
    centerMode: true,
    centerPadding: '20px',
  ...
  // Activate/deactivate slider for mobile/desktop
  function maybeActivateSlider() {
    if (isMobile()) {
  ...
  maybeActivateSlider();
  $window.resize(maybeActivateSlider);
...
function initEventsPages() {
  ...
  if (buttonsBlock.length) {
    var buttonsBlockOffset = buttonsBlock.offset();
    var buttonsPosition = buttonsBlockOffset.top;
  }
  var eventsList = $('.events_list');
  var dayHeader = $('.day_header');
  var calendarModule = $('.m__calendar_holder');
  var calendarOpenControl = $('.fx_button_date');
  ...
  function headersStickyToggleShow() {
    if (window_w < mobile_point) {
      initStickyHeaders();
    }
    else if (window_w > mobile_point) {
      destroyStickyHeaders();
    }
  }

  function destroyModalBlocks() {
    if (window_w > mobile_point) {
      closeObject(calendarModule, calendarOpenControl);
      closeObject(categoriesModule, categoriesOpenControl);
    }
  }

  function initStickyHeaders() {
    eventsList.stickem({offset: 83, start: 20});
  }

  function destroyStickyHeaders() {
    var sticky = eventsList.stickem({offset: 83, start: 0});
    sticky.destroy();
    dayHeader.each(function () {
      var that = $(this);
      that.removeClass('stickit');
    });
  }

  function fixedButtonsBlock() {
    var fromTop = $(window).scrollTop();

    if (fromTop > buttonsPosition) {
      $body.addClass('hasBottomBlock');
      buttonsBlock.addClass('fixedMod');
    }
    else {
      $body.removeClass('hasBottomBlock');
      buttonsBlock.removeClass('fixedMod');
    }
  }
  ...
  function openObject(openBlock, openControl) {
    ...
    buttonsBlock.addClass('objectOpen');
  }

  function closeObject(openBlock, openControl) {
    openBlock.removeClass('open');
    openControl.removeClass('open');
    buttonsBlock.removeClass('objectOpen');
  }

  function closeSibling(siblingBlock, siblingOpenControl) {
...
function initGridSlider() {
  ...
  var last_slider_state = false;
  var $el = $('.grid_image_slider_wrap');
  var $el_text_exist = $('.slider_text_exist');
  var $el_mobile = $('.grid_image_mobile_slider_wrap');
  if (!$el.length) {
    return;
  }

  if ($el_text_exist.length) {
    $el_text_exist.each(function () {
      var parent = $(this).closest('.grid_image_wrap');

      if (!parent.hasClass('text_exist')) {
        parent.addClass('text_exist');
      }
    });
  }
  ...
  var el_mobile_array = [];
  var slides_array = [];
  var slides_mobile_array = [];

  $el.each(function () {
    var $this = $(this);
    el_array.push($this);

    var grid_image_b = $this.closest('.o_grid_module').find('.grid_image_b');

    var sub_array = [];

    grid_image_b.each(function () {
      var $this = $(this);
      var sub_sub_array = {
        'dscr_text': $('.grid_image_dscr_text', $this).text(),
        'grid_image': $('.grid_image', $this).attr('src')
      };
      sub_array.push(sub_sub_array);
    });

    slides_array.push(sub_array);
  });

  $el_mobile.each(function () {
    var $this = $(this);
    el_mobile_array.push($this);
    ...
    slides_mobile_array.push(sub_array);
  });
  ...
  function sliders_f(mod) {
    if (mod == 'desktop') {
      if (last_slider_state != 'desktop') {

        if (last_slider_state == 'mobile' &&
            typeof el_mobile_array !== 'undefined' &&
            el_mobile_array.length > 0) {

          $.each(el_mobile_array, function (key, value) {
            value.slick('unslick');
          });
        }
        if (last_slider_state == 'mobile') {
          $('.grid_image_b.cloned_mod').remove();
        }
        $.each(el_array, function (key, value) {

          if (first_load) {
            value.slick('unslick');
          }
          if (last_slider_state == 'mobile') {
            $('.grid_image_b.cloned_mod', value).remove();
          }
          value.slick({
            dots: true,
            infinite: true,
      ...
      if (last_slider_state != 'mobile') {
        ...
        $.each(el_array, function (key, value) {
          ...
          $.each(slides_array[key], function (sub_key, sub_value) {
            if (sub_key < 2) {
              value.slick('slickAdd', '<figure class="grid_image_b cloned_mod">	<div class="grid_image_w"><img class="grid_image" src="' + sub_value.grid_image + '" alt=""></div><figcaption class="grid_image_dscr"><div class="grid_image_dscr_text">' + sub_value.dscr_text + '</div></figcaption></figure>');
            }
          });
        });

        if (typeof el_mobile_array !== 'undefined' &&
            el_mobile_array.length > 0) {
          $.each(el_mobile_array, function (key, value) {


            if (!value.hasClass('slick-initialized')) {
              value.slick({
                dots: true,
                infinite: true,
                arrows: false,
              ...
              $.each(slides_mobile_array[key], function (sub_key, sub_value) {
                if (sub_key < 2) {
  ...
  $window.on('resize', $.throttle(250, grid_resize));
...
/**
 * Hero Slider with 3 CTAs
 */

function initHeroSlider() {
  var $slider = $('.o__hero>.hero_container>.hero_slider');
  ...
  $slider.find('.slide').each(function () {
    ...
    if ($video.length) {
      $video.get(0).play(); // Play the mp4 video
    }

    var $iframe = $(this).find('iframe');
    if ($iframe.length) {
      if ('vimeo' === $iframe.attr('data-type')) {
        var iframe = $iframe[0],
            player = $f(iframe),
            status = $('.status');
  ...
  var $controls_wrap = $('.o__hero>.hero_container>.slider_controls>.controls_wrap');
  var $controls = $controls_wrap.find('.control');
  var $indicator = $controls_wrap.find('.indicator>.actual');

  function setIndicatorWidth() {
    // Set the same width as the control div.
    if (isMobile()) {
      $indicator.css('width', $indicator.parent().next().width() / 2)
    } else {
      $indicator.css('width', $indicator.parent().next().width())
    }
  }

  setIndicatorWidth();
  $window.on('resize', setIndicatorWidth);
  $controls.each(function () {
    var $control = $(this);
    $control.mouseenter(function () {
      var nextSlide = $(this).attr('data-slide');
      $slider.slick('slickGoTo', nextSlide);
      $indicator.css('left', $(this).offset().left - $controls_wrap.offset().left);
...
function resizeHeroTitle() {
  $('.o__hero .title').fitText(1.2, {minFontSize: '30px', maxFontSize: '100px'});

}


function initMenuOverlay() {
  var $menu = $('.o__menu_overlay');
  var $body = $('body');
  var $window = $(window);
  if (!$menu.length) {
    return;
  }
  var $background = $menu.find('.background');
  var $hamburger = $('.hamburgerBtn');
  var $close = $menu.find('.close');

  // Set background width/size dynamically.
  function setBgSize() {
  ...
  // Set nav footer top
  initMenuOverlayResize();

  $window.on('resize', $.throttle(250, initMenuOverlayResize));

  function initMenuOverlayResize() {
    setBgSize();
  }
  ...
  // Set the mobile accordion
  if (isMobile() && $('.menu_accordion').has("div").length) {
    UIkit.accordion('.menu_accordion');
  }
}

function initNewsPages() {
  var buttonsBlock = $('.m__buttons_block_fixed');
  var yearModule = $('.m__years_accordion');
  var yearOpenControl = $('.fx_button_date');
  var objCloseControl = $('.obj_close_btn');
  var categoriesModule = $('.m__categories_accordion');
  var categoriesOpenControl = $('.fx_button_category');
  var category = 0;
  ...
  $('.categories_filter').find('li>a').each(function () {
  ...
  $('.years_filter').find('li>a').each(function () {
    $(this).click(function (e) {
      e.preventDefault();
      var $link = $(this);
      year = $link.find('.c_year').html();
      $('.m__years_accordion').find('.year_hold').html(year);
      page = 1;
      if ('press' === template) {
        fetchPress();
      } else {
  ...
  function formatUrl(url) {
    var params = false;
    if (year > 0) {
      var from = new Date(year + '-01-01').toISOString();
      var to = new Date(year + '-12-31').toISOString();
  ...
  function fetchPress() {
    var url = '//' + window.location.host + '/wp-json/wp/v2/sun_press?';
    url = formatUrl(url);
    $.ajax({
      url: encodeURI(url)
    }).done(function (data) {
      ...
      if (data.length) {
        for (var i = 0; i < data.length; i++) {
          html += renderPress(data[i]);
        }
      }

      $('.press_list').html(html);
    });
  }
  ...
  function fetchArticles() {
    ...
    $.ajax({
      ...
      var html = '';
      for (var i = 0; i < data.length; i++) {
        html += renderNews(data[i])
      }
      $('.o__news_page').find('.news_list').html(html);
    });
  }

  function renderPress(data) {
    return ('<a href="' + data.acf.pdf_upload.url + '"' +
    'target="_blank" class="press_release press_release_item">' +
    '<div class="thumbnail"' +
    'style="background-image: url(' + data.acf.press_thumbnail_image + ')"> ' +
  ...
  function renderNews(data) {
    ...
    '</div>' +
    '<a href="' + data.link + '" title="" class="a__read_more_link">' +
    'Read More' +
    '</a>' +
    '</div>' +
    '</div>' +
  ...
  $(window).on('resize', resize_f);
  initFixedButtonsBlock();

  initObjectFullPage(yearOpenControl, yearModule, objCloseControl, categoriesModule, categoriesOpenControl);
  initObjectFullPage(categoriesOpenControl, categoriesModule, objCloseControl, yearModule, yearOpenControl);
  ...
  function initFixedButtonsBlock() {
    if (isMobile()) {
      $body.addClass('hasBottomBlock');
      buttonsBlock.addClass('fixedMod');
    }
  ...
  function destroyModalBlocks() {
    if (!isMobile()) {
      closeObject(yearModule, yearOpenControl);
      closeObject(categoriesModule, categoriesOpenControl);
    }
  }
...
function protectedPageFunctions() {

  var parent = $('.o__protected_page_block');
  var fieldFocus = $('.focus_mod');
  var submitBtn = $('.submit_mod');
  var closeBtn = $('.prot_close_btn');
  var showPassBtn = $('.show_pass');
  var show = true;
  ...
  function showPass() {
    showPassBtn.on('click', function (e) {
      e.preventDefault();
      if ('' !== fieldFocus.val()) {
        fieldFocus.get(0).type = show ? 'text' : 'password';
        show = !show;
      }
    })
  }
  ...
  function onChange() {
    fieldFocus.on('input', function () {
      ('' === $(this).val()) ? submitBtn.removeClass('good_data') : submitBtn.addClass('good_data');
    })
  }
  ...
  function hideTitle() {
    fieldFocus.on('focus', function () {
      parent.addClass('focus_on');
    });
    submitBtn.on('click', function () {
      parent.removeClass('focus_on');
    });
  }
  ...
  function checkInputValue() {
    fieldFocus.blur(function () {
      if (!this.value) {
        $(this).addClass('empty').removeClass('not_empty');
      }
      else {
        $(this).addClass('not_empty').removeClass('empty');
      }
    });
  }
  ...
  function hidePage() {
    closeBtn.on('click', function () {
      parent.removeClass('show focus_on');
    });
  }
...
/**
 * Full width/height white overlay for search.
 */
...
function initSearchOverlay() {
  ...
  var $overlay = $('.o__search_overlay');
  var $close = $overlay.find('.close');
  var $body = $('body');
  var $html = $('html');

  var $textWrapper = $overlay.find('.text');
  var $input = $textWrapper.find('input[type="text"]');
  var $border = $textWrapper.find('.border_bottom');
  ...
  $search.click(toggleOverlay);
  $close.click(toggleOverlay);

  // Redirect to the search
  $input.on('keyup', function (e) {
    if (e.keyCode == 13) {
      window.location = $input.attr('data-search-url') + $input.val();
    }
  });

  $('.o__search_overlay').on('click', function (e) {
    if (modal) {
      var $this = $(e.target);
      if (!$this.hasClass('close_blocker')) {
        toggleOverlay();
      }
    }
  });
...
/**
 * Slider quotes for Tour estate
 */


function initSliderQuotes() {
  $('.slider_quotes_list').each(
      function () {
        var thatElem = $(this);
        startSliderQuotes(thatElem);
      }
  );
}


function startSliderQuotes(sliderItem) {
  var slidesQuotesArray = [];
  var sliderDelaySeconds = 5;
  var $sliderQuotes = sliderItem;
  var sliderModule = $sliderQuotes.parent('.o__slider_quotes');
  var progress = $('.quotes_progress', sliderModule);


  if ($sliderQuotes.length < 1) {
    return;
  }
  // create Array elements-text and hide all them
  $(".slide_quotes_item", $sliderQuotes).each(function (index, elem) {
    var el = $(".slider_quotes_w", elem);
    slidesQuotesArray.push(el);
    TweenMax.set(el, {yPercent: sliderDelaySeconds, opacity: 0});

  });

  if (slidesQuotesArray.length == 1) {
    progress.hide();
  }

  //show first element-text and show progress bar
  $sliderQuotes.on('init', function (event, slick) {
    TweenMax.set(progress, {opacity: 1});
    TweenMax.to(slidesQuotesArray[0], 1, {yPercent: 0, opacity: 1});
    TweenMax.from(progress, sliderDelaySeconds, {xPercent: -100, ease: Power0.easeNone});
  });
  ...
  $sliderQuotes.slick({
    ...
    pauseOnFocus: false,
    pauseOnHover: false,
    autoplaySpeed: sliderDelaySeconds * 1000,
    autoplay: true,
    fade: true,
    cssEase: 'linear'
  });

  // there is animations with text and progress bar
  $sliderQuotes.on('beforeChange', function (event, slick, currentSlide, nextSlide) {
    TweenMax.to(progress, 1, {yPercent: -100, opacity: 0, ease: Power3.easeIn});

    TweenMax.set(slidesQuotesArray[nextSlide], {yPercent: 5, opacity: 0});
    TweenMax.to(slidesQuotesArray[currentSlide], 1, {yPercent: -5, opacity: 0, ease: Power3.easeIn});
    TweenMax.to(slidesQuotesArray[nextSlide], 1, {yPercent: 0, opacity: 1, delay: 1, ease: Power3.easeOut});

  });
  $sliderQuotes.on('afterChange', function () {
    TweenMax.set(progress, {yPercent: 0, xPercent: -100, opacity: 1});
    TweenMax.to(progress, sliderDelaySeconds, {xPercent: 0, ease: Power0.easeNone});
  });
}


/**
 * Slick slider for the "Visit us" section in mobile.
 */
function initRecirculationSlider() {
  var $slider = $('.mobile_slider');
...
/**
 * Animations and transitions for Two hero modules Organism.
 */
...
function initCalendar() {
  ...
  var $eventsList = $('.events_list');
  var $eventDate = $eventsList.find('.events_item');
  var $events = $eventsList.find('.event_b_list');
  var fetching = false;
  var first = true;
  ...
  var template = $('.press_release').length ? 'press' : 'events';

  var $datePicker = $wrapper.datepicker({
    showOtherMonths: false,
    prevHtml: months[currentMonth - 1],
    nextHtml: months[currentMonth + 1],
    navTitles: {
      days: 'MM'
    },
    onChangeMonth: function () {
      getCurrentMonth();
      setValuePrevNextMonths();
    },
    onSelect: function (formattedDate, date, inst) {
      if (first && 'events' === template) {
        // Ignore first fetch when the date is selected an unselect default date.
        $wrapper.data('datepicker').clear();
        first = false;
        return;
      }
      if (!formattedDate || fetching) {
        return;
      }
  ...
  // Category filter
  $categories.find('.categories_item').each(function () {
    $(this).click(function (e) {
      e.preventDefault();
      var $cat = $(this);
  ...
  // Init datepicker in today's date.
  if ('events' === template) {
  ...
  /**
   * Render events in the HTML.
   * @param data
   */
  function renderEvents(data) {
    // Render selected date
    $eventDate.find('.day_hold').html(data.formatted_date);
    $eventDate.find('.day_note').html('');
    $events.html('');
    var html = '';
    if (data.events.length) {
      for (var i = 0; i < data.events.length; i++) {
        html += renderSingleEvent(data.events[i]);
      }
  ...
  function getCurrentMonth() {
    ...
    var indexComma = navTitle.split("").indexOf(',');

    //get nav title text if title has year or hasnt year
    var getCurrentMonthText = indexComma > 0 ? navTitle.slice(0, indexComma) : navTitle;

    getCurrentMonthIndex = months.indexOf(getCurrentMonthText);

  }

  function setValuePrevNextMonths() {
    var navNextCell = $('.datepicker--nav-action[data-action="next"]');
    var navPrevCell = $('.datepicker--nav-action[data-action="prev"]');
    // set value for nav cells
    //IFS - december to january or january to december

    if (getCurrentMonthIndex == 11) {
      navNextCell.text(months[0]);
    }
    else {
      navNextCell.text(months[getCurrentMonthIndex + 1]);
    }

    if (getCurrentMonthIndex == 0) {
      navPrevCell.text(months[11]);
    }
    else {
...
function initCategoriesList() {
  ...
  categoryTitle.on('click', function () {
    var that = $(this);
    var thatCategoriesList = that.next('.categories_list');

    if (thatCategoriesList.hasClass('open') || thatCategoriesList.is(':visible')) {
      thatCategoriesList.removeClass('open').stop(true, true).slideUp();
    }
    else {
      thatCategoriesList.addClass('open').stop(true, true).slideDown();
    }
  });
...
function initContentThumbAnimation() {
  ...
  $(window).on('load', function () {
    $('.content_thumb_b').each(function (index, elem) {
      var that = $(this);
      var sub_array;
      TweenMax.set(that, {opacity: 1});
      if (that.hasClass('horizontal_mod')) {
        sub_array = {
          el: that,
          image: TweenMax.from($('.content_t_img_hold', that), .3, {
            opacity: 0,
            delay: .1,
            ease: Power2.easeOut,
            paused: true
          }),
          text: TweenMax.from($('.content_t_desc', that), .6, {
            opacity: 0,
            xPercent: 15,
            delay: .4,
            ease: Power2.easeOut,
  ...
  function resize() {
    $.each(thumbArray, function (index, elem) {
      elem.position = elem.el.offset().top;
    });
  }
    ...
    if (page_load) {
      $.each(thumbArray, function (index, elem) {
        if ($scrollTopGl + window_h * .6 > elem.position) {
          ...
          if (!elem.isShown) {
            if (index > 0 && elem.position == thumbArray[index - 1].position) {
              if (index > 1 && elem.position == thumbArray[index - 2].position) {
...
function printElement(text) {
  var dimensions = 'height=' + window.innerHeight + ', width=' + window.innerWidth + ', top=0, left=0';
  var myWindow = window.open('', 'PRINT', dimensions);
  var html = '<html><head><title>' + document.title + '</title></head><body>' +
      '<h1>' + String(document.title) + '</h1>' + text + '</body></html>';
...
function initFAQ() {
  ...
  UIkit.accordion('.m__faq');

}

function initHistorySlider() {
  var $historySlider = $('.m__history_module');
...
function initDirectionsMap() {
  var $container = $('.m__map');

  if ($container.length <= 0) {
    return;
  }
  var position = {
    lat: parseFloat($container.attr('data-lat')),
    lng: parseFloat($container.attr('data-lng'))
  };
...
function initSidebarFunctions() {
  ...
  function initSidebar() {
    ...
    sidebarTop = firstBlockHeight + (header_h - 40) + topPadding;

    if (sidebar.length && window_w > 1440) {
      sidebarState = true;
  ...
  function initSidebarFixed() {
    sidebarTop = firstBlockHeight + header_h + topPadding;

    if ($scrollTopGl > site_h - (sidebarH + footer_h && !fixedFooterMod)) {
      sidebar.addClass('fixedFooterMod');
      fixedFooterMod = true;
    }
    else if ($scrollTopGl < site_h - (sidebarH + footer_h && fixedFooterMod)) {
      sidebar.removeClass('fixedFooterMod');
      fixedFooterMod = false;
    }

    if ($scrollTopGl > sidebarTop - header_h && !fixedMod) {
      sidebar.addClass('fixedMod');
      fixedMod = true;
    }
    else if ($scrollTopGl < sidebarTop - header_h && fixedMod) {
      sidebar.removeClass('fixedMod');
      fixedMod = false;
    }
  }
...
function initSingleVideo() {
  $('.js-poster-video').each(function () {
    var $poster = $(this);
    $poster.on('click', function () {
      $poster.css('background-image', 'none');
      $poster.css('background-color', '#000');
      $poster.html('<iframe class="video active"' +
          'src="' + $poster.attr('data-external-url') + '?autoplay=1"' +
