...
function emulPlaceholder(){Modernizr.input.placeholder||($("[placeholder]").focus(function(){var l=$(this);l.val()==l.attr("placeholder")&&(l.val(""),l.removeClass("placeholder"))}).blur(function(){var l=$(this);(""==l.val()||l.val()==l.attr("placeholder"))&&(l.addClass("placeholder"),l.val(l.attr("placeholder")))}).blur(),$("[placeholder]").parents("form").submit(function(){$(this).find("[placeholder]").each(function(){var l=$(this);l.val()==l.attr("placeholder")&&l.val("")})}))}
function selectStyling(e,l){$(e).selectOrDie({customClass:l}),console.log("selectOrDie")}