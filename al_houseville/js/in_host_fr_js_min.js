...
(function (e) {
	...
	e(document).mouseup(function () {
		...
		start: function (t, i, s) {
			...
			}).left - s.margins.left)), !s.snapElements[c].snapping && (a || n || r || o || p) && s.options.snap.snap && s.options.snap.snap.call(s.element, t, e.extend(s._uiHash(), {snapItem: s.snapElements[c].item})), s.snapElements[c].snapping = a || n || r || o || p)
		}
		...
		_animate: function (e, t, i) {
			...
			return "number" == typeof u && (n = u), "string" == typeof u && (a = u), a = a || u.easing || l.easing, n = n || u.duration || l.duration, t.length ? e.length ? (s = e.show().outerHeight(), t.animate(this.hideProps, {
				...
				duration: n, easing: a, complete: d, step: function (e, i) {
	...
	e.extend(a.prototype, {
		...
		version: "1.11.0", options: {
			...
			if (s) {
				...
				}, e.fx.interval)), this._trigger("open", t, {tooltip: n}), r = {
					keyup: function (t) {
...
window.Modernizr = function (e, t, n) {
	function r() {
		f.input = function (e) {
			for (var t = 0, n = e.length; n > t; t++)T[e[t]] = e[t]in b;
			return T
		}("autocomplete autofocus list placeholder max min multiple pattern required step".split(" ")), f.inputtypes = function (e) {
			for (var r, i, o, a = 0, l = e.length; l > a; a++)b.setAttribute("type", i = e[a]), r = "text" !== b.type, r && (b.value = C, b.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(i) && b.style.WebkitAppearance !== n ? (h.appendChild(b), o = t.defaultView, r = o.getComputedStyle && "textfield" !== o.getComputedStyle(b, null).WebkitAppearance && 0 !== b.offsetHeight, h.removeChild(b)) : /^(search|tel)$/.test(i) || (/^(url|email)$/.test(i) ? r = b.checkValidity && b.checkValidity() === !1 : /^color$/.test(i) ? (h.appendChild(b), h.offsetWidth, r = b.value != C, h.removeChild(b)) : r = b.value != C)), w[e[a]] = !!r;
			return w
		}("search tel url email datetime date month week time datetime-local number range color".split(" "))
	}

	function i(e, t) {
		var n = e.charAt(0).toUpperCase() + e.substr(1), r = (e + " " + E.join(n + " ") + n).split(" ");
		return o(r, t)
	}

	function o(e, t) {
		for (var r in e)if (v[e[r]] !== n)return "pfx" == t ? e[r] : !0;
		return !1
	}
	...
	var u, d, p = "2.0.6", f = {}, m = !0, h = t.documentElement, g = (t.head || t.getElementsByTagName("head")[0], "modernizr"), y = t.createElement(g), v = y.style, b = t.createElement("input"), C = ":)", S = (Object.prototype.toString, " -webkit- -moz- -o- -ms- -khtml- ".split(" ")), E = "Webkit Moz O ms Khtml".split(" "), x = {}, w = {}, T = {}, k = [], j = function (e, n, r, i) {
		var o, a, l, s = t.createElement("div");
		if (parseInt(r, 10))for (; r--;)l = t.createElement("div"), l.id = i ? i[r] : g + (r + 1), s.appendChild(l);
		return o = ["&shy;", "<style>", e, "</style>"].join(""), s.id = g, s.innerHTML += o, h.appendChild(s), a = n(s, e), s.parentNode.removeChild(s), !!a
	}, N = {}.hasOwnProperty;
	d = l(N, n) || l(N.call, n) ? function (e, t) {
		return t in e && l(e.constructor.prototype[t], n)
	} : function (e, t) {
		return N.call(e, t)
	}, x.rgba = function () {
		return c("background-color:rgba(150,255,150,.5)"), a(v.backgroundColor, "rgba")
	}, x.multiplebgs = function () {
		return c("background:url(https://),url(https://),red url(https://)"), /(url\s*\(.*?){3}/.test(v.background)
		...
		return c((e + S.join(t + e) + S.join(n + e)).slice(0, -e.length)), a(v.backgroundImage, "gradient")
	}, x.cssreflections = function () {
		return i("boxReflect")
	}, x.csstransitions = function () {
		return i("transitionProperty")
	};
	for (var L in x)d(x, L) && (u = L.toLowerCase(), f[u] = x[L](), k.push((f[u] ? "" : "no-") + u));
	return f.input || r(), c(""), y = b = null, e.attachEvent && function () {
		var e = t.createElement("div");
		return e.innerHTML = "<elem></elem>", 1 !== e.childNodes.length
	}() && function (e, t) {
		function r(e) {
			for (var t = -1; ++t < s;)e.createElement(l[t])
		}

		e.iepp = e.iepp || {};
		var i, o = e.iepp, a = o.html5elements || "abbr|article|aside|audio|canvas|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", l = a.split("|"), s = l.length, c = new RegExp("(^|\\s)(" + a + ")", "gi"), u = new RegExp("<(/*)(" + a + ")", "gi"), d = /^\s*[\{\}]\s*$/, p = new RegExp("(^|[^\\n]*?\\s)(" + a + ")([^\\n]*)({[\\n\\w\\W]*?})", "gi"), f = t.createDocumentFragment(), m = t.documentElement, h = m.firstChild, g = t.createElement("body"), y = t.createElement("style"), v = /print|all/;
		o.getCSS = function (e, t) {
			if (e + "" === n)return "";
			for (var r, i = -1, a = e.length, l = []; ++i < a;)r = e[i], r.disabled || (t = r.media || t, v.test(t) && l.push(o.getCSS(r.imports, t), r.cssText), t = "all");
			return l.join("")
		}, o.parseCSS = function (e) {
			for (var t, n = []; null != (t = p.exec(e));)n.push(((d.exec(t[1]) ? "\n" : t[1]) + t[2] + t[3]).replace(c, "$1.iepp_$2") + t[4]);
			return n.join("\n")
		}, o.writeHTML = function () {
			var e = -1;
			for (i = i || t.body; ++e < s;)for (var n = t.getElementsByTagName(l[e]), r = n.length, o = -1; ++o < r;)n[o].className.indexOf("iepp_") < 0 && (n[o].className += " iepp_" + l[e]);
			f.appendChild(i), m.appendChild(g), g.className = i.className, g.id = i.id, g.innerHTML = i.innerHTML.replace(u, "<$1font")
		}, o._beforePrint = function () {
			y.styleSheet.cssText = o.parseCSS(o.getCSS(t.styleSheets, "all")), o.writeHTML()
		}, o.restoreHTML = function () {
			g.innerHTML = "", m.removeChild(g), m.appendChild(i)
		}, o._afterPrint = function () {
			o.restoreHTML(), y.styleSheet.cssText = ""
		}, r(t), r(f), o.disablePP || (h.insertBefore(y, h.firstChild), y.media = "print", y.className = "iepp-printshim", e.attachEvent("onbeforeprint", o._beforePrint), e.attachEvent("onafterprint", o._afterPrint))
	}(e, t), f._version = p, f._prefixes = S, f._domPrefixes = E, f.testProp = function (e) {
		return o([e])
	}, f.testAllProps = i, f.testStyles = j, h.className = h.className.replace(/\bno-js\b/, "") + (m ? " js " + k.join(" ") : ""), f
	...
	function i() {
		for (var e = 1, t = -1; y.length - ++t && (!y[t].s || (e = y[t].r)););
		e && l()
	}

	function o(e) {
		var n, o = t.createElement("script");
		o.src = e.s, o.onreadystatechange = o.onload = function () {
			!n && r(o.readyState) && (n = 1, i(), o.onload = o.onreadystatechange = null)
		}, m(function () {
			n || (n = 1, i())
		}, p.errorTimeout), e.e ? o.onload() : h.parentNode.insertBefore(o, h)
	}

	function a(e) {
		var n, r = t.createElement("link");
		if (r.href = e.s, r.rel = "stylesheet", r.type = "text/css", e.e || !x && !b)r.onload = function () {
			n || (n = 1, m(function () {
				i()
			}, 0))
		}, e.e && r.onload(); else {
			var o = function (e) {
				m(function () {
					if (!n)try {
						e.sheet.cssRules.length ? (n = 1, i()) : o(e)
					} catch (t) {
						1e3 == t.code || "security" == t.message || "denied" == t.message ? (n = 1, m(function () {
							i()
						}, 0)) : o(e)
					}
				}, 0)
		...
		m(function () {
			n || (n = 1, i())
		}, p.errorTimeout), !e.e && h.parentNode.insertBefore(r, h)
	}
	...
	function s(e, n, o, a, s, c) {
		function u() {
			!f && r(d.readyState) && (g.r = f = 1, !v && i(), d.onload = d.onreadystatechange = null, m(function () {
				S.removeChild(d)
			}, 0))
		}

		var d = t.createElement(e), f = 0, g = {t: o, s: n, e: c};
		d.src = d.data = n, !C && (d.style.display = "none"), d.width = d.height = "0", "object" != e && (d.type = o), d.onload = d.onreadystatechange = u, "img" == e ? d.onerror = u : "script" == e && (d.onerror = function () {
			g.e = g.r = 1, l()
		}), y.splice(a, 0, g), S.insertBefore(d, C ? null : h), m(function () {
			f || (S.removeChild(d), g.r = g.e = f = 1, i())
		}, p.errorTimeout)
	}

	function c(e, t, n) {
		var r = "c" == t ? k : T;
		return v = 0, t = t || "j", L(e) ? s(r, e, t, this.i++, f, n) : (y.splice(this.i++, 0, e), 1 == y.length && l()), this
	}
	...
	var d, p, f = t.documentElement, m = e.setTimeout, h = t.getElementsByTagName("script")[0], g = {}.toString, y = [], v = 0, b = "MozAppearance"in f.style, C = b && !!t.createRange().compareNode, S = C ? f : h.parentNode, E = e.opera && "[object Opera]" == g.call(e.opera), x = "webkitAppearance"in f.style, w = x && "async"in t.createElement("script"), T = b ? "object" : E || w ? "img" : "script", k = x ? "img" : T, j = Array.isArray || function (e) {
	...
	p = function (e) {
		function t(e) {
			var t, n, r = e.split("!"), i = P.length, o = r.pop(), a = r.length, l = {url: o, origUrl: o, prefixes: r};
			for (n = 0; a > n; n++)t = A[r[n]], t && (l = t(l));
			for (n = 0; i > n; n++)l = P[n](l);
			return l
		}
		...
		function r(e, r, i, o, a) {
			...
			if (!l.bypass) {
				if (r && (r = M(r) ? r : r[e] || r[o] || r[e.split("/").pop().split("?")[0]]), l.instead)return l.instead(e, r, i, o, a);
				i.load(l.url, l.forceCSS || !l.forceJS && /css$/.test(l.url) ? "c" : n, l.noexec), (M(r) || M(s)) && i.load(function () {
					u(), r && r(l.origUrl, a, o), s && s(l.origUrl, a, o)
				})
			}
		}
		...
		function i(e, t) {
			function n(e) {
				if (L(e))r(e, s, t, 0, o); else if (N(e))for (i in e)e.hasOwnProperty(i) && r(e[i], s, t, i, o)
			}

			var i, o = !!e.test, a = o ? e.yep : e.nope, l = e.load || e.both, s = e.callback;
			n(a), n(l), e.complete && t.load(e.complete)
		}

		var o, a, l = this.yepnope.loader;
		if (L(e))r(e, 0, l, 0); else if (j(e))for (o = 0; o < e.length; o++)a = e[o], L(a) ? r(a, 0, l, 0) : j(a) ? p(a) : N(a) && i(a, l); else N(e) && i(e, l)
...
(function (e) {
	e.fn.selectOrDie = function (t) {
		...
		var o = {
			initSoD: function (t) {
				...
				return this.each(function (t) {
					if (!e(this).parent().hasClass("sod_select")) {
						var n = e(this), i = r.customID ? r.customID : n.data("custom-id") ? n.data("custom-id") : r.customID, s = r.customClass ? r.customClass : n.data("custom-class") ? n.data("custom-class") : r.customClass, u = r.prefix ? r.prefix : n.data("prefix") ? n.data("prefix") : r.prefix, a = r.placeholder ? r.placeholder : n.data("placeholder") ? n.data("placeholder") : r.placeholder, f = r.cycle || n.data("cycle") ? true : r.cycle, l = r.links || n.data("links") ? true : r.links, c = r.linksExternal || n.data("links-external") ? true : r.linksExternal, h = r.size ? r.size : n.data("size") ? n.data("size") : r.size, p = r.tabIndex ? r.tabIndex : n.data("tabindex") ? n.data("tabindex") : n.attr("tabindex") ? n.attr("tabindex") : r.tabIndex, d = n.prop("title") ? n.prop("title") : null, v = n.is(":disabled") ? " disabled" : "", m = "", g = "", y = 0, b, w, E;
						if (u) {
							m = '<span class="sod_prefix">' + u + "</span> "
						}
						if (a && !u) {
							g += '<span class="sod_label sod_placeholder">' + a + "</span>"
						} else {
							g += '<span class="sod_label">' + m + "</span>"
						}
						b = e("<span/>", {
							id: i,
							"class": "sod_select " + s + v,
							title: d,
							tabindex: p,
							html: g,
							"data-cycle": f,
						...
						w = e("<span/>", {"class": "sod_list_wrapper"}).appendTo(b);
						E = e("<span/>", {"class": "sod_list"}).appendTo(w);
						e("option, optgroup", n).each(function (t) {
							o.populateSoD(e(this), E, b)
						});
						if (h) {
							w.show();
							e(".sod_option:lt(" + h + ")", E).each(function (t) {
								y += e(this).outerHeight()
							});
							w.removeAttr("style");
							E.css({"max-height": y})
						}
						n.appendTo(b);
						b.on("focusin", o.focusSod).on("click", o.triggerSod).on("click", ".sod_option", o.optionClick).on("mousemove", ".sod_option", o.optionHover).on("keydown keypress", o.keyboardUse);
						n.on("change", o.selectChange);
						e("html").on("click", function () {
							o.blurSod(b)
						});
						e(document).on("click", "label[for='" + n.attr("id") + "']", function (e) {
							e.preventDefault();
							b.focus()
						})
					} else {
			...
			}, populateSoD: function (t, n, r) {
				var i = r.data("placeholder"), s = r.data("prefix"), o = t.parent(), u = t.text(), a = t.val(), f = t.data("custom-id") ? t.data("custom-id") : null, l = t.data("custom-class") ? t.data("custom-class") : "", c = t.is(":disabled") ? " disabled " : "", h = t.is(":selected") ? " selected active " : "", p = t.data("link") ? " link " : "", d = t.data("link-external") ? " linkexternal" : "";
				if (t.is("option")) {
					e("<span/>", {
						"class": "sod_option " + l + c + h + p + d,
						id: f,
						title: u,
						html: u,
						"data-value": a
				...
				var t = e(this), n = e(".sod_select.focus");
				...
				t.stopPropagation();
				var n = e(this), r = n.find(".sod_list"), i = n.data("placeholder"), u = n.find(".selected");
				if (!n.hasClass("disabled") && !n.hasClass("open") && !n.hasClass("touch")) {
					n.addClass("open");
					e(".sod_select").not(this).removeClass("open focus");
					if (i && !n.data("prefix")) {
						n.find(".sod_label").addClass("sod_placeholder").html(i)
					}
					o.listScroll(r, u);
					o.checkViewport(n, r)
				} else {
					clearTimeout(s);
					n.removeClass("open above")
				}
			}, keyboardUse: function (t) {
				var n = e(this), r = n.find(".sod_list"), s = n.find(".sod_option"), u = n.find(".sod_label"), a = n.data("cycle"), f = s.filter(".active"), l, c, h, p, d;
				if (t.which !== 0 && t.charCode !== 0) {
					clearTimeout(i);
					n.data("filter", n.data("filter") + String.fromCharCode(t.keyCode | t.charCode));
					l = s.filter(function () {
					...
					if (l.length) {
						...
						l.addClass("active");
						o.listScroll(r, l);
						u.get(0).lastChild.nodeValue = l.text()
					}
				...
				if (t.which > 36 && t.which < 41) {
					if (t.which === 37 || t.which === 38) {
						c = f.prevAll(":not('.disabled, .optgroup')").first();
						h = s.not(".disabled, .optgroup").last()
					} else if (t.which === 39 || t.which === 40) {
						c = f.nextAll(":not('.disabled, .optgroup')").first();
						h = s.not(".disabled, .optgroup").first()
					}
					if (!c.hasClass("sod_option") && a) {
						c = h
					}
					if (c.hasClass("sod_option") || a) {
						f.removeClass("active");
						c.addClass("active");
						u.get(0).lastChild.nodeValue = c.text();
						o.listScroll(r, c)
					}
					return false
				} else if (t.which === 13 || t.which === 32 && n.hasClass("open") && n.data("filter") === "") {
					t.preventDefault();
					f.click()
				} else if (t.which === 32 && !n.hasClass("open") && n.data("filter") === "") {
					t.preventDefault();
					n.click()
				} else if (t.which === 27) {
					o.blurSod(n)
				...
				t.stopPropagation();
				var n = e(this), r = n.closest(".sod_select"), i = n.hasClass("disabled"), o = n.hasClass("optgroup"), u = r.find(".sod_option:not('.optgroup')").index(this);
				if (!i && !o) {
				...
				clearTimeout(s);
				r.removeClass("open above")
			}, selectChange: function () {
				var t = e(this), n = t.find(":selected"), i = n.text(), s = t.closest(".sod_select");
				...
				if (e("body").find(t).length) {
					var n = t.data("label"), r = t.find(".active"), i = t.find(".selected");
					clearTimeout(s);
					if (t.hasClass("focus") && !t.hasClass("open")) {
						r.click()
					} else if (!r.hasClass("selected")) {
						t.find(".sod_label").get(0).lastChild.nodeValue = n;
						r.removeClass("active");
						i.addClass("active")
					}
					t.removeClass("open focus above");
					t.blur()
				}
			}, checkViewport: function (t, n) {
				var r = t[0].getBoundingClientRect(), i = n.outerHeight();
				...
				var n = e[0].getBoundingClientRect(), r = t[0].getBoundingClientRect();
				if (n.top > r.top) {
		...
		var u = {
			destroy: function () {
				return this.each(function (t) {
					var n = e(this), r = n.parent();
					if (r.hasClass("sod_select")) {
						n.off("change");
						r.find("span").remove();
						n.unwrap()
					} else {
				...
				return this.each(function (t) {
					var n = e(this), r = n.parent(), i = r.find(".sod_list:first");
					if (r.hasClass("sod_select")) {
						i.empty();
						r.find(".sod_label").get(0).lastChild.nodeValue = "";
						if (n.is(":disabled")) {
							r.addClass("disabled")
						}
						e("option, optgroup", n).each(function (t) {
							o.populateSoD(e(this), i, r)
						})
					} else {
				...
				return this.each(function (n) {
					var r = e(this), i = r.parent();
					if (i.hasClass("sod_select")) {
						if (typeof t !== "undefined") {
							i.find(".sod_list:first .sod_option[data-value='" + t + "']").addClass("disabled");
							i.find(".sod_list:first .sod_option[data-label='" + t + "']").nextUntil(":not(.groupchild)").addClass("disabled");
							e("option[value='" + t + "'], optgroup[label='" + t + "']", this).prop("disabled", true)
						} else if (i.hasClass("sod_select")) {
							i.addClass("disabled");
				...
				return this.each(function (n) {
					...
					if (i.hasClass("sod_select")) {
						if (typeof t !== "undefined") {
							i.find(".sod_list:first .sod_option[data-value='" + t + "']").removeClass("disabled");
							i.find(".sod_list:first .sod_option[data-label='" + t + "']").nextUntil(":not(.groupchild)").removeClass("disabled");
		...
		if (u[t]) {
			...
			return o.initSoD.apply(this, arguments)
		} else {
...
!function (e, t, n, i) {
	...
	n.extend(s, {
		...
		_setDimension: function () {
			var e, t, i, o, a, r, l, c, d, p = s.getViewport(), h = 0, m = !1, y = !1, m = s.wrap, x = s.skin, v = s.inner, w = s.current, y = w.width, b = w.height, k = w.minWidth, C = w.minHeight, O = w.maxWidth, W = w.maxHeight, _ = w.scrolling, S = w.scrollOutside ? w.scrollbarWidth : 0, T = w.margin, L = u(T[1] + T[3]), E = u(T[0] + T[2]);
...
!function (t) {
	...
	t.fn.bxSlider = function (s) {
		if (0 != this.length) {
			...
			e.el = this;
			var r = function () {
				o.settings = t.extend({}, n, s), o.children = a.children(o.settings.slideSelector), o.settings.randomStart && (o.settings.startSlide = Math.floor(Math.random() * o.children.length)), o.active = {index: o.settings.startSlide}, o.carousel = o.settings.minSlides > 1 || o.settings.maxSlides > 1, o.minThreshold = o.settings.minSlides * o.settings.slideWidth + (o.settings.minSlides - 1) * o.settings.slideMargin, o.maxThreshold = o.settings.maxSlides * o.settings.slideWidth + (o.settings.maxSlides - 1) * o.settings.slideMargin, o.working = !1, o.controls = {}, o.animProp = "vertical" == o.settings.mode ? "top" : "left", o.usingCSS = o.settings.useCSS && "fade" != o.settings.mode && function () {
					var t = document.createElement("div"), e = ["WebkitPerspective", "MozPerspective", "OPerspective", "msPerspective"];
					for (var i in e)if (void 0 !== t.style[e[i]])return o.cssPrefix = e[i].replace("Perspective", "").toLowerCase(), o.animProp = "-" + o.cssPrefix + "-transform", !0;
					return !1
				}(), "vertical" == o.settings.mode && (o.settings.maxSlides = o.settings.minSlides), l()
			}, l = function () {
				if (a.wrap('<div class="bx-wrapper"><div class="bx-viewport"></div></div>'), o.viewport = a.parent(), o.loader = t('<div class="bx-loading" />'), o.viewport.prepend(o.loader), a.css({
						width: "horizontal" == o.settings.mode ? 215 * o.children.length + "%" : "auto",
						position: "relative"
					}), o.usingCSS && o.settings.easing ? a.css("-" + o.cssPrefix + "-transition-timing-function", o.settings.easing) : o.settings.easing || (o.settings.easing = "swing"), o.viewport.css({
						width: "100%",
						height: "50",
						overflow: "hidden",
						position: "relative"
						...
						listStyle: "none"
					}), "slider_main" == a.attr("id") && o.children.css({width: c()}), "horizontal" == o.settings.mode && o.settings.slideMargin > 0 && o.children.css("marginRight", o.settings.slideMargin), "vertical" == o.settings.mode && o.settings.slideMargin > 0 && o.children.css("marginBottom", o.settings.slideMargin), "fade" == o.settings.mode && (o.children.css({
						position: "absolute",
						zIndex: 0,
						display: "none"
						...
						zIndex: 50,
						display: "block"
					})), o.controls.el = t('<div class="bx-controls" />'), o.settings.captions && b(), o.settings.infiniteLoop && "fade" != o.settings.mode && !o.settings.ticker) {
				...
				o.active.last = o.settings.startSlide == h() - 1, o.settings.video && a.fitVids(), o.settings.ticker || (o.settings.pager && x(), o.settings.controls && m(), o.settings.auto && o.settings.autoControls && S(), (o.settings.controls || o.settings.autoControls || o.settings.pager) && o.viewport.after(o.controls.el)), a.children().imagesLoaded(function () {
					o.loader.remove(), p(), "vertical" == o.settings.mode && (o.settings.adaptiveHeight = !0), o.viewport.animate({height: d()}, 200, function () {
						o.settings.onSliderLoad(o.active.index)
					}), o.settings.auto && o.settings.autoStart && z(), o.settings.ticker && q(), o.settings.pager && A(o.settings.startSlide), o.settings.controls && M(), o.settings.touchEnabled && !o.settings.ticker && D()
				})
			}, d = function () {
				var e = 0, n = t();
				if ("vertical" == o.settings.mode || o.settings.adaptiveHeight)if (o.carousel) {
					var s = 1 == o.settings.moveSlides ? o.active.index : o.active.index * u();
				...
				return 0 == o.settings.slideWidth ? t = e : e > o.maxThreshold ? t = (e - o.settings.slideMargin * (o.settings.maxSlides - 1)) / o.settings.maxSlides : e < o.minThreshold && (t = (e - o.settings.slideMargin * (o.settings.minSlides - 1)) / o.settings.minSlides), t
			}, g = function () {
				var t = 1;
				...
				var t = 0;
				if (o.settings.moveSlides > 0)if (o.settings.infiniteLoop)t = o.children.length / u(); else for (var e = 0, i = 0; e < o.children.length;)++t, e = i + g(), i += o.settings.moveSlides <= g() ? o.settings.moveSlides : g(); else t = Math.ceil(o.children.length / g());
				return t
			}, u = function () {
				...
				if (o.active.last) {
					...
					o.active.index == h() - 1 && (o.active.last = !0), void 0 != e && ("horizontal" == o.settings.mode ? v(-e.left, "reset", 0) : "vertical" == o.settings.mode && v(-e.top, "reset", 0))
				}
			}, v = function (t, e, i, n) {
				if (o.usingCSS) {
					...
					a.css("-" + o.cssPrefix + "-transition-duration", i / 1e3 + "s"), "slide" == e ? (a.css(o.animProp, s), a.bind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", function () {
						a.unbind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd"), k()
					})) : "reset" == e ? a.css(o.animProp, s) : "ticker" == e && (a.css("-" + o.cssPrefix + "-transition-timing-function", "linear"), a.css(o.animProp, s), a.bind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", function () {
						a.unbind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd"), v(n.resetValue, "reset", 0), L()
					}))
				} else {
					var r = {};
				...
				n != o.active.index && a.goToSlide(n), e.preventDefault()
			}, A = function (t) {
				return "short" == o.settings.pagerType ? (o.pagerEl.html(t + 1 + o.settings.pagerShortSeparator + o.children.length), void 0) : (o.pagerEl.find("a").removeClass("active"), o.pagerEl.find("a").eq(t).addClass("active"), void 0)
			}, k = function () {
				if (o.settings.infiniteLoop) {
					var t = "";
					0 == o.active.index ? t = o.children.eq(0).position() : o.active.index == h() - 1 && o.carousel ? t = o.children.eq((h() - 1) * u()).position() : o.active.index == o.children.length - 1 && (t = o.children.eq(o.children.length - 1).position()), "horizontal" == o.settings.mode ? v(-t.left, "reset", 0) : "vertical" == o.settings.mode && v(-t.top, "reset", 0)
				}
				o.working = !1, o.settings.onSlideAfter(o.children.eq(o.active.index), o.oldIndex, o.active.index)
			}, y = function (t) {
				o.settings.autoControlsCombine ? o.controls.autoEl.html(o.controls[t]) : (o.controls.autoEl.find("a").removeClass("active"), o.controls.autoEl.find("a:not(.bx-" + t + ")").addClass("active"))
			}, M = function () {
				!o.settings.infiniteLoop && o.settings.hideControlOnEnd && (0 == o.active.index ? (o.controls.prev.addClass("disabled"), o.controls.next.removeClass("disabled")) : o.active.index == h() - 1 ? (o.controls.next.addClass("disabled"), o.controls.prev.removeClass("disabled")) : (o.controls.prev.removeClass("disabled"), o.controls.next.removeClass("disabled")))
			}, z = function () {
				...
				if (o.touch.end.x = e.changedTouches[0].pageX, o.touch.end.y = e.changedTouches[0].pageY, "fade" == o.settings.mode) {
					...
					var n = 0;
					"horizontal" == o.settings.mode ? (n = o.touch.end.x - o.touch.start.x, i = o.touch.originalPos.left) : (n = o.touch.end.y - o.touch.start.y, i = o.touch.originalPos.top), !o.settings.infiniteLoop && (0 == o.active.index && n > 0 || o.active.last && 0 > n) ? v(i, "reset", 200) : Math.abs(n) >= o.settings.swipeThreshold ? (0 > n ? a.goToNextSlide() : a.goToPrevSlide(), a.stopAuto()) : v(i, "reset", 200)
				}
				o.viewport.unbind("touchend", W)
			};
			a.goToSlide = function (e, i) {
				if (!o.working && o.active.index != e)if (o.working = !0, o.oldIndex = o.active.index, o.active.index = 0 > e ? h() - 1 : e >= h() ? 0 : e, o.settings.onSlideBefore(o.children.eq(o.active.index), o.oldIndex, o.active.index), "next" == i ? o.settings.onSlideNext(o.children.eq(o.active.index), o.oldIndex, o.active.index) : "prev" == i && o.settings.onSlidePrev(o.children.eq(o.active.index), o.oldIndex, o.active.index), o.active.last = o.active.index >= h() - 1, o.settings.pager && A(o.active.index), o.settings.controls && M(), "fade" == o.settings.mode)o.settings.adaptiveHeight && o.viewport.height() != d() && o.viewport.animate({height: d()}, o.settings.adaptiveHeightSpeed), o.children.filter(":visible").fadeOut(o.settings.speed).css({zIndex: 0}), o.children.eq(o.active.index).css("zIndex", 51).fadeIn(o.settings.speed, function () {
					...
					if (!o.settings.infiniteLoop && o.carousel && o.active.last)if ("horizontal" == o.settings.mode) {
						...
						s = r.position(), n = o.viewport.width() - r.width()
					} else {
						var l = o.children.length - o.settings.minSlides;
						s = o.children.eq(l).position()
					} else if (o.carousel && o.active.last && "prev" == i) {
						var c = 1 == o.settings.moveSlides ? o.settings.maxSlides - u() : (h() - 1) * u() - (o.children.length - o.settings.maxSlides), r = a.children(".bx-clone").eq(c);
						s = r.position()
					} else if ("next" == i && 0 == o.active.index)s = a.find(".bx-clone").eq(o.settings.maxSlides).position(), o.active.last = !1; else if (e >= 0) {
						var g = e * u();
						s = o.children.eq(g).position()
					}
					var p = "horizontal" == o.settings.mode ? -(s.left - n) : -s.top;
				...
				}, o.settings.pause), o.settings.autoControls && 1 != t && y("stop"))
			}, a.stopAuto = function (t) {
				o.interval && (clearInterval(o.interval), o.interval = null, o.settings.autoControls && 1 != t && y("start"))
			...
			return t(window).resize(function () {
				...
				(N != e || B != i) && (N = e, B = i, "slider_main" == a.attr("id") && o.children.add(a.find(".bx-clone")).width(c()), o.viewport.css("height", d()), o.active.last && (o.active.index = h() - 1), o.active.index >= h() && (o.active.last = !0), o.settings.pager && !o.settings.pagerCustom && (f(), A(o.active.index)), o.settings.ticker || p())
			}), r(), this
		}
	}
}(jQuery), function (t, e) {
	...
	t.fn.imagesLoaded = function (n) {
		function s() {
			var e = t(g), i = t(h);
			r && (h.length ? r.reject(d, e, i) : r.resolve(d)), t.isFunction(n) && n.call(a, d, e, i)
		}
		...
		function o(e, n) {
			e.src === i || -1 !== t.inArray(e, c) || (c.push(e), n ? h.push(e) : g.push(e), t.data(e, "imagesLoaded", {
				isBroken: n,
				src: e.src
			}), l && r.notifyWith(t(e), [n, d, t(g), t(h)]), d.length === c.length && (setTimeout(s), d.unbind(".imagesLoaded")))
		}

		var a = this, r = t.isFunction(t.Deferred) ? t.Deferred() : 0, l = t.isFunction(r.notify), d = a.find("img").add(a.filter("img")), c = [], g = [], h = [];
		return t.isPlainObject(n) && t.each(n, function (t, e) {
			"callback" === t ? n = e : r && r[t](e)
		}), d.length ? d.bind("load.imagesLoaded error.imagesLoaded", function (t) {
			o(t.target, "error" === t.type)
		}).each(function (n, s) {
			var a = s.src, r = t.data(s, "imagesLoaded");
			r && r.src === a ? o(s, r.isBroken) : s.complete && s.naturalWidth !== e ? o(s, 0 === s.naturalWidth || 0 === s.naturalHeight) : (s.readyState || s.complete) && (s.src = i, s.src = a)
		}) : s(), r ? r.promise(a) : a
	}
}(jQuery);
function emulPlaceholder() {
	Modernizr.input.placeholder || ($("[placeholder]").focus(function () {
		var l = $(this);
		l.val() == l.attr("placeholder") && (l.val(""), l.removeClass("placeholder"))
	}).blur(function () {
		var l = $(this);
		("" == l.val() || l.val() == l.attr("placeholder")) && (l.addClass("placeholder"), l.val(l.attr("placeholder")))
...
function initFancybox(a) {
	var e = $(a);
	e.attr("rel", "gallery"), e.fancybox({padding: 0, helpers: {overlay: {locked: !1}}})
}
function selectStyling(e, s) {
	$(e).selectOrDie({customClass: s})
}
function initBxSliderOneSlide(e) {
	var t = $(e);
	t.bxSlider({pager: !1, mode: "fade", controls: !0, prevText: "", nextText: "", auto: !0, speed: 4e3})
}
function initTabsIndex(t) {
	var e = $(t), a = e.find(".tabs_item"), s = e.find(".tabs_c_item");
	a.on("click", function () {
		var t = $(this), e = t.attr("data-tab");
		a.removeClass("selected"), s.removeClass("selected"), t.addClass("selected"), s.each(function () {
			$(this).attr("data-content") == e && $(this).addClass("selected")
		})
	})
}
function carousel(e) {
	function t() {
		$(".carousel_obj_list li").each(function () {
			i = $(this).find("img").width(), $(this).css({width: i})
		})
	}
...
function showRequestBox() {
	$(".request_box").hover(function () {
		$(this).addClass("active")
	}, function () {
		$(this).removeClass("active")
	})
}
function initSelectMenu(e) {
	var t = $(".myClass-1 .sod_list_wrapper"), i = $(e);
	i.hover(function () {
		$(this).find(t).fadeIn(0)
	}, function () {
		$(this).find(t).fadeOut(0)
	})
}
$(function () {
	$(".request_box").length && showRequestBox(), $(".search_box").length, $(".carousel_obj_list").length && carousel(".carousel_obj_list"), $(".main_slider").length && initBxSliderOneSlide(".main_slider"), $(".form_sel_v1").length && selectStyling(".form_sel_v1", "myClass-1"), $(".car_link").length && initFancybox(".car_link"), $(".tabs_block").length && initTabsIndex(".tabs_block"), initSelectMenu(".head_currency"), initSelectMenu(".head_langs"), emulPlaceholder()
}), $(document).on("click", function (e) {
	var t = $(e.target).closest(".search_block").length, i = $(e.target).closest(".request_box").length;
	t || i || ($(".search_box").removeClass("active"), $(".request_box").removeClass("active"), e.stopPropagation())
});