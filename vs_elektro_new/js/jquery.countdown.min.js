 ...
 *
 * v2.0.0. intervalsCnt, startTimeNext, startTimeEnd - added by Alexander Lobanov, LLC Orion Soft.
 */

(function($){var init=function(userOptions){if(userOptions.intervalsCurrent==undefined||userOptions.intervalsCurrent==0){userOptions.intervalsCurrent=1}else{userOptions.intervalsCurrent++;if(userOptions.intervalsCurrent==userOptions.intervalsCnt){userOptions.startTime=userOptions.startTimeEnd;}else{userOptions.startTime=userOptions.startTimeNext;}}
var _userOptions=userOptions;var _this=this;var options={stepTime:60,format:"dd:hh:mm:ss",startTime:"01:12:32:55",startTimeNext:"",startTimeEnd:"",intervalsCnt:1,digitImages:6,digitWidth:53,digitHeight:77,autoStart:true,timerEnd:function(){},image:"digits.png"};var digits=[],interval;var createDigits=function(where){var c=0;var hCounter=0;var mCounter=0;var sCounter=0;if((typeof options.startTime=='object')&&(options.startTime.constructor==Date)){var now=new Date();if(options.startTime.getTime()<now.getTime()){options.startTime.setFullYear(options.startTime.getFullYear()+1);}
